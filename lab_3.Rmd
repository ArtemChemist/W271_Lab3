...
Drivers licensing process is represented by `gradual_dl` indicating if there is a step-wise process to obtaining a full licence.
...
av_explore <- my_panel %>%
  group_by(year) %>%
  summarise(mean_fat = mean(total_fatal_per_pop),
                       pop = sum(state_pop),
